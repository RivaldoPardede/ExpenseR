<?php
    ...
    if(!isset($_SESSION['email'])) {
        ...
        $username = pg_fetch_array(pg_query($connection, "SELECT username FROM users WHERE email = '$email'"))[0];
    }
            ...
            <div x-data="{ sidebarOpen: false }" class="flex h-screen rounded-r-xl">
                ...
                <section id="sidebar">
                    ...
                    <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" class="fixed rounded-r-xl inset-y-0 left-0 z-30 w-64 overflow-y-auto transition duration-200 transform bg-white h-screen dark:bg-slate-700 lg:translate-x-0 lg:static lg:inset-0 shadow-xl">
                        ...
                        <nav class="mt-10">
                            <a class="flex my-5 items-center font-semibold px-6 py-2 text-white bg-primary shadow-lg shadow-primary/50 rounded-xl mx-5" href="dashboard.php">
                ...
                <section id="main" class="flex-1 overflow-x-hidden overflow-y-auto">
                    <span>
                        <h2 class="text-3xl font-semibold mt-4 text-slate-700 pb-3 border-b-2 drop-shadow-2xl dark:text-slate-100 text-center">Dashboard</h2>
                        <div class="container px-6 pt-8 mx-auto">
                            <h3 class="text-3xl font-medium text-slate-700 drop-shadow-2xl dark:text-slate-100 text-center">Hello, <?= $username ?>!</h3>
                            ...
                            <div class="flex flex-col ">
                                <div class="py-2 sm:py-10 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                                        ...
                                        <table class="min-w-full">
                                            ...
                                            <?php 
                                                ...
                                                if($searchUserId):
                                                    ...
                                                    $user_id = $row['user_id'];
                                                    $readDataQuery = pg_query($connection, "SELECT * FROM transaksi where user_id = '$user_id' ORDER BY transaction_date DESC LIMIT 5"); 
                                                    if($readDataQuery):
                                                        $rows = pg_fetch_all($readDataQuery);
                                                        foreach($rows as $row):
                                    ...
                                    <a href="transaction.php">
                                        <button
                                            type="button"
                                            class="flex flex-wrap justify-center mx-auto mt-5 w-[50%] sm:w-[40%] md:w-[20%] rounded-full bg-primary px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#14a44d] transition duration-150 ease-in-out hover:bg-success-600 hover:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] focus:bg-success-600 focus:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] focus:outline-none focus:ring-0 active:bg-success-700 active:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(20,164,77,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)]">
                                            See More
                                        </button>
                                    </a>
                                </div>
